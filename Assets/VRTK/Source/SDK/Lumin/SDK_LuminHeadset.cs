...
namespace VRTK
{
    ...
    /// <summary>
    /// The Lumin Headset SDK script provides a bridge to the Lumin OS.
    /// </summary>
    [SDK_Description(typeof(SDK_Lumin))]
    public class SDK_LuminHeadset
...
#endif
    {
        ...
        public override Transform GetHeadset()
        {
            ...
            {
                GameObject luminHeadsetGO = VRTK_SharedMethods.FindEvenInactiveGameObject<SDK_LuminCameraRig>("Camera");
                if (luminHeadsetGO != null)
                {
                    cachedHeadset = luminHeadsetGO.transform;
                }
            }
